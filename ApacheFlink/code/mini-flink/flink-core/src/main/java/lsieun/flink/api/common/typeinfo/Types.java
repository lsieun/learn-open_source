...
import lsieun.flink.api.java.tuple.Tuple;
import lsieun.flink.api.java.typeutils.EitherTypeInfo;
import lsieun.flink.api.java.typeutils.EnumTypeInfo;
import lsieun.flink.api.java.typeutils.GenericTypeInfo;
import lsieun.flink.api.java.typeutils.ListTypeInfo;
import lsieun.flink.api.java.typeutils.MapTypeInfo;
import lsieun.flink.api.java.typeutils.ObjectArrayTypeInfo;
import lsieun.flink.api.java.typeutils.PojoField;
import lsieun.flink.api.java.typeutils.PojoTypeInfo;
import lsieun.flink.api.java.typeutils.RowTypeInfo;
import lsieun.flink.api.java.typeutils.TupleTypeInfo;
import lsieun.flink.api.java.typeutils.TypeExtractor;
import lsieun.flink.api.java.typeutils.ValueTypeInfo;
import lsieun.flink.types.Either;
import lsieun.flink.types.Row;
 ...
 * (See <code>lsieun.flink.api.scala.Types</code> and <code>lsieun.flink.table.api.Types</code>)
 *
...
public class Types {
	...
	/**
	 * Returns type information for {@link lsieun.flink.types.Row} with fields of the given types.
	...
	/**
	 * Returns type information for {@link lsieun.flink.types.Row} with fields of the given types and
	...
	/**
	 * Returns type information for subclasses of Flink's {@link lsieun.flink.api.java.tuple.Tuple}
	 * (namely {@link lsieun.flink.api.java.tuple.Tuple0} till {@link lsieun.flink.api.java.tuple.Tuple25})
	...
	/**
	 * Returns type information for typed subclasses of Flink's {@link lsieun.flink.api.java.tuple.Tuple}.
	 * Typed subclassed are classes that extend {@link lsieun.flink.api.java.tuple.Tuple0} till
	 * {@link lsieun.flink.api.java.tuple.Tuple25} to provide types for all fields and might add
	 ...
	 * type information for all fields, an {@link lsieun.flink.api.common.functions.InvalidTypesException}
	 * is thrown.
	 *
	 * <p>Example use:
	 * <pre>
	 ...
	 * </pre>
	 *
	 * @param tupleSubclass A subclass of {@link lsieun.flink.api.java.tuple.Tuple0} till
	 *                      {@link lsieun.flink.api.java.tuple.Tuple25} that defines all field types and
	 ...
	 * {@link lsieun.flink.api.common.functions.InvalidTypesException} is thrown.
	 *
	 ...
	 * {@link lsieun.flink.types.Value}). Built-in value types do not support null values (except
	 * for {@link lsieun.flink.types.StringValue}).
	 *
	 ...
	 * {@link lsieun.flink.types.BooleanValue}, {@link lsieun.flink.types.IntValue}) as well
	 * as {@link lsieun.flink.types.StringValue}, {@link lsieun.flink.types.NullValue},
	 * {@link lsieun.flink.types.ListValue}, and {@link lsieun.flink.types.MapValue}.
	 *
	 * @param valueType class that implements {@link lsieun.flink.types.Value}
	 */
	...
	/**
	 * Returns type information for Flink's {@link lsieun.flink.types.Either} type. Null values
	 * are not supported.
	 *
	 ...
	 *
	 * @param leftType type information of left side / {@link lsieun.flink.types.Either.Left}
	 * @param rightType type information of right side / {@link lsieun.flink.types.Either.Right}
	 */
