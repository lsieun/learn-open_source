...
public abstract class TypeComparator<T> implements Serializable {
	 ...
	 * the end. 
	 * <p>
	 * This method is similar to {@link lsieun.flink.types.NormalizableKey#copyNormalizedKey(MemorySegment, int, int)}. In the case that
	 ...
	 * 
	 * @see lsieun.flink.types.NormalizableKey#copyNormalizedKey(MemorySegment, int, int)
	 */
