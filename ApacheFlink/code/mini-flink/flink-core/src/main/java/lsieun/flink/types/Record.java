...
import lsieun.flink.core.memory.MemoryUtils;
...
public final class Record implements Value, CopyableValue<Record> {
	...
	/**
	 * Writes this record to the given output view. This method is similar to {@link lsieun.flink.core.io.IOReadableWritable#write(lsieun.flink.core.memory.DataOutputView)}, but
