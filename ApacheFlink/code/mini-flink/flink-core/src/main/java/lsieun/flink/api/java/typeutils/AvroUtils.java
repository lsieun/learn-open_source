...
import static lsieun.flink.api.java.typeutils.TypeExtractionUtils.hasSuperclass;
...
import lsieun.flink.api.java.typeutils.runtime.KryoRegistration;
import lsieun.flink.api.java.typeutils.runtime.kryo.Serializers;
...
public abstract class AvroUtils {
	...
	private static final String AVRO_KRYO_UTILS = "lsieun.flink.formats.avro.utils.AvroKryoSerializerUtils";
	...
	private static class DefaultAvroUtils extends AvroUtils {
		...
		private static final String AVRO_SPECIFIC_RECORD_BASE = "lsieun.avro.specific.SpecificRecordBase";

		private static final String AVRO_GENERIC_RECORD = "lsieun.avro.generic.GenericData$Record";

		private static final String AVRO_GENERIC_DATA_ARRAY = "lsieun.avro.generic.GenericData$Array";
