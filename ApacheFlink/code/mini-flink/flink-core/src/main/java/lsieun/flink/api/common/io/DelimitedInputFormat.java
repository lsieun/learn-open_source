...
import lsieun.flink.configuration.OptimizerOptions;
...
public abstract class DelimitedInputFormat<OT> extends FileInputFormat<OT> {
    ...
    public FileBaseStatistics getStatistics(BaseStatistics cachedStats) throws IOException {
        ...
        try {
            ...
            // NEEDTODO: Add sampling for unsplittable files. Right now, only compressed text files are affected by this limitation.
            if (unsplittable) {
                return stats;
            }
     ...
     *
     * @see lsieun.flink.api.common.io.FileInputFormat#open(lsieun.flink.core.fs.FileInputSplit)
     */
    @Override
